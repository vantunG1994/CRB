						...
						<div class="author">
					        ...
					        <span class="my-account-header-settings">
                                ...
                                if(!empty($resume)) {
                                    ...
                                    ?>
                                    <a class="button-ag-full" href="#"><i class="fa fa-file-text-o"></i>Thêm hồ sơ cá nhân</a>
                                    <?php
                                }
                                ?>
													...
													<div id="show_user_package" class="full" style="margin-bottom: 0px; display: block;">
														...
														<div class="table show_user_package">
															...
															<div class="plan popular" id="Diamond">
																...
																<div class="select-packge select-wrapper">
                            ...
                            <div class="col-xs-12">
                                ...
                                <table class="table  box-table">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $wpjobus_company_fullname ;?> (<?php echo $status; ?>)</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a onclick='return confirm("Bạn có chắc chắn xoá hồ sơ này?")' href='#'><i class="fa fa-trash-o"></i></a>
                                ...
                                <table class="table  box-table">
                                    ...
                                    foreach ($job_id as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"></td>
                                            <td class="text-center">Gần đây</td>
                                            <td class="text-center"><?php echo $status; ?></td>
                                            <td class="text-center">0</td>
                                            <td class="text-center">
                                                <a href="<?php $edit_job = home_url('/')."edit-job/?job_id=".$td_result_job[$key]; echo $edit_job; ?>"><i class="fa fa-pencil-square-o"></i></a>
                                                <a onclick='return confirm("Bạn có chắc muốn xoá tin đăng này?")' href=''><i class="fa fa-trash-o"></i></a>
                                ...
                                foreach ($listing_id as $key => $value) {
                                    ...
                                    <?php if (get_post_status($listing_id) == 'publish') { ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php $listinglink =get_permalink($listing_id); echo $listinglink; ?>"><?php echo $listing_fullname; ?></a></td>
                                            <td class="text-center"><?php echo $type;?></td>
                                            <td class="text-center"></td>
                                            <td class="text-center"><a href="#<?php echo $listing_id; ?>"><i class="fa fa-trash-o"></i></a></td>
                                        </tr>
                                        <?php
                                    }
                                }
