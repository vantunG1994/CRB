      ...
      <div class="form-input">
          ...
          <div class="col-md-6">
            <div class="information-add-edit">
              ...
              <span class="information-input" >
                ...
                <span class="three_fifth select-wrapper " >
                  ...
                  <select class="input-lg" name="job_career_level" id="job_career_level" style="width: 100%;">
              ...
              <span class="information-input" >
                ...
                <span class="three_fifth select-wrapper " >
                  ...
                  <select class="input-lg select2-hidden-accessible" name="job_type" id="job_type" style="width: 100%;" tabindex="-1" aria-hidden="true">
                    <option value="Chính thức">Chính thức</option>
                    <option value="Bán thời gian">Bán thời gian</option>
                    <option value="Lao động tự do ">Lao động tự do </option>
                    <option value="Thực tập sinh">Thực tập sinh</option>
                    </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-job_type-container"><span class="select2-selection__rendered" id="select2-job_type-container" title="Chính thức">Chính thức</span><span class="select2-selection__arrow" role="select_style"><b role="select_style"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                  </span>
                </span>
                <span class="information-input" >
                  <span class="label-title" >
                  ...
                  <span class="three_fifth select-wrapper" >
                    ...
                    <select class="input-lg" name="job_time_trial" id="job_time_trial" style="width: 100%;">
                ...
                <span class="information-input" >
                  ...
                  <span class="three_fifth " >
                    ...
                    <input id="expired_at" class="input-lg" type="date" name="expired_at" vk_1ffd1="subscribed">
                  </span>
                </span>
                <span class="information-input" >
                  <span class="label-title" >
                  ...
                  <span class="three_fifth select-wrapper" ><i class="fa fa-building"></i>
                    <select class="input-lg" name="job_company" id="job_company" style="width: 100%;">
                      ...
                      <option value="73940">Chi nhánh công ty TNHH Sáng Thịnh tại Hà Nội</option>
                    </select>
                  </span>
                </span>
            ...
            <div class="col-md-6">
              <div class="information-add-edit">
                ...
                <span class="information-img">
                  <span class="information-input" >
                    <h3><i class="fa fa-picture-o"></i>Ảnh bìa:</h3>
                  </span>
                  <div >
                    <img class="criteria-image" id="your_cover_url_img" src="" style="float: left; width: auto; margin-bottom: 20px; margin-top: 10px; max-height: 340px;">
                  </div>
                  <input class="criteria-image-url" id="your_icover_url" type="text" size="36" name="wpjobus_job_cover_image"  value="">
                  <input class="criteria-image-id" id="your_cover_id" type="text" size="36" name="wpjobus_job_cover_image_id"  value="">
                  <i class="fa fa-trash-o"></i><input class="criteria-image-button-remove button" id="your_image_url_button_remove582" type="button" value="Delete Image"> <br>
                  <i class="fa fa-cloud-upload"></i><input class="criteria-image-button button" id="your_image_url_button582" type="button" value="Upload Image">
                  <script>
        ...
        <div class="welfare">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="price-welfare-1">
                ...
                <span class="price-welfare-day" >
                  ...
                  <input class="input-lg" type="text"  value="" placeholder="Nhập phúc lợi"  vk_1ffd1="subscribed">
                </span>
                <p id="error" style="color: red;display:none;font-size: 16px;"></p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="price-welfare-1">
                ...
                <span class="price-welfare-day" >
                  <textarea  row="20" placeholder="Nhập nội dung mô tả"></textarea>
                </span>
              </div>
            </div>
          </div>
          <div class="delete-add">
            ...
            <a href="them" class="add"><i class="fa fa-plus-circle" aria-hidden="true"></i> Thêm phúc lợi</a>
          </div>
        </div>
        <div class="divider"></div>
        <div class="contact">
