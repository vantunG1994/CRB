                    ...
                    <ul class="nav nav-tabs caribe-border-bottom-fff">
                        <li role="presentation" class="active">
                            <div class="title t-curpointer title_h1_green">
                                <h1 class="news-h1-title caribe-breadcum">Ứng viên <?php if($job_type=='resume'){$job_type="";} echo $job_type ?:""; ?></h1>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="discription-top">
                    <h2>Ứng viên <?php if($job_type=='resume'){$job_type="";} echo $job_type ?:""; ?></h2>
                    ...
                    <h3> Ung vien <?php echo $_GET['industry'] ?:""; ?> </h3>
                </div>
