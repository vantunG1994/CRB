...
<div class="main-content">
    <div class="coverImageHolder">
        <div class="cover">
            <?php
            if($wpjobus_company_cover_image=="")
            {
            $wpjobus_company_cover_image="/wp-content/themes/CRB/images/job-banner-1.jpg";
            }
            ?>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="banner-top">
                        <section id="banner-top">
                            ...
                            <span class="cover-resume-breadcrumbs"><a rel="nofollow" href="<?php echo home_url(); ?>/"><i class="fa fa-home"></i></a> <i class="fa fa-chevron-right"></i> <a href="<?php echo home_url(); ?>/ho-so-doanh-nghiep">Doanh Nghiệp</a> <i class="fa fa-chevron-right"></i> <a href="#"><?php echo $company_industry; ?></a>  </span>
                        </section>
                    </div>
                </div>
            </div>
                    ...
                    <div class="two_third" style="margin-bottom: 0;">
                        ...
                        <div class="one_third" style="margin-bottom: 0;">
                            <span class="job-offers-post-badge" >
                                <span class="job-offers-post-badge-job-type" ><?php echo $wpjobus_job_type =$td_jobOffer["wpjobus_job_expired"]; ?></span>
