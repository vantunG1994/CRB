...
$check_view = $wpdb->get_var("SELECT * FROM crb_mycv WHERE post_id = '$td_this_post_id' AND uid= '$current_user->ID'");
    // echo "<pre>";
        ...
        foreach($result_resume as $resume)
        {
            ...
            $wpjobus_resume_native_language = esc_attr(get_post_meta($td_this_post_id, 'wpjobus_resume_native_language',true))?:"Tiếng Việt";
    ...
    ?>
        <div class="main-content">
                ...
                <?php
                                 ...
                                 {
                                     $wpjobus_resume_cover_image="/wp-content/themes/CRB/images/job-banner-1.jpg";
                                 }
                ?>
                <img src="<?php echo $wpjobus_resume_cover_image; ?>" alt="" class="bgImg">
                        </div>
                        <div class="container">
                                <div class=row>
                                ...
                                <span class="cover-resume-breadcrumbs"><a rel="nofollow" href="<?php echo home_url(); ?>"><i class="fa fa-home"></i></a> <i class="fa fa-chevron-right"></i> <a href="<?php echo home_url(); ?>/tuyen-dung">Tuyển dụng</a> <i class="fa fa-chevron-right"></i> <a href="<?php echo home_url(); ?>/ung-vien-theo-nganh-nghe/<?php echo createSlug($td_resume_industry); ?>"><?php echo !empty($td_resume_industry)?$td_resume_industry:''; ?></a>  </span>
                                                        </section>
                                                </div>
                                        </div>
                                </div>
                            ...
                            <h2 class="resume-author-subtitle" ><?php echo $wpjobus_resume_prof_title; ?></h2>
                                ...
                                <img  src="<?php echo $src; ?>" alt="<?php echo $wpjobus_resume_fullname; ?>"></span>
                                            ...
                                            <?php
                                                                                                                ...
                                                                                                                {
                                            ?>
                                            <span class="experience-period"><?php echo esc_attr( $td_resume_years_of_exp ); ?> <?php _e( 'Năm KN', 'themesdojo' ); ?></span>
                                            <?php
                                                                                                                }
                                                                                                                else{
                                            ?>
                                                                                                                    <span class="experience-period">Chưa có KN</span>
                                            <?php
                                                                                                                }
                                            ?>
                                                                            </span>
                                        ...
                                        <?php if ($wpjobus_resume_remuneration!=""  ) { ?>
                                            ...
                                            ?>
                                            <span class="experience-period" style="font-size: 12px;"><?php echo "Thoả thuận"; ?></span>
                                            <?php
                                            } ?>
            ...
            <?php if($wpjobus_resume_comm_level > 0 || strlen(trim($wpjobus_resume_comm_note))>0 || $wpjobus_resume_org_level > 0 || strlen(trim($wpjobus_resume_org_note)) >0 || $wpjobus_resume_job_rel_level > 0 || strlen(trim($wpjobus_resume_job_rel_note)) >0 || !empty($wpjobus_resume_skills) || strlen(trim($wpjobus_resume_native_language))>0 || !empty($wpjobus_resume_languages) || !empty($wpjobus_resume_hobbies)) { ?>
                ...
                <h3 class="resume-section-title"><i class="fa fa-rocket"></i><?php _e( 'Kỹ Năng', 'themesdojo' ); ?></h3>
                    ...
                    ?>
                    <div class="<?php echo $class_language;?>">
                        ...
                        ?>
                            ...
                            <div class="full animate"><span class="main-skills-item-title-language native-language-all"><?php echo esc_attr( $wpjobus_resume_languages[$i][0] )?:"Tiếng Anh"; ?></span></div>
            ...
            <?php } ?>
                        ...
                        <div class="information">
                                <div class="row">
                                        <div class="col-xs-12 col-md-8">
                                                <h2 class="resume-section-title" ><i class="fa fa-list-ul"></i>Liên hệ với ứng viên</h2>
                        ...
                        ?>
                                                    <a href="#" rel="nofollow" class="btn btn-primary" style="font-size: 16px;" id="show">+ Xem chi tiết hồ sơ ứng viên</a>
                        ...
                        <?php
                                                ...
                                                {
                        ?>
                                                    <h4>Hãy nâng cấp tài khoản VIP để xem thông tin liên lạc của ứng viên</h4>
                                                    <a href="#" rel="nofollow" onclick="add_vip_user()"  class="btn btn-primary" style="">Nâng Cấp Tài Khoản VIP </a>
                        <?php
                                                }
                        ?>
                                        </div>
                        ...
                        ?>
                            ...
                            <div class="listting-more">
                                ...
                                <a href="<?php echo home_url('/')?>ung-vien/?industry=<?php echo createSlug($td_resume_industry);?>&resume_location=<?php echo $wpjobus_resume_location ?>"><p style="color: #16a085 !important;padding-top: 2%;font-weight: bold;text-align:-webkit-auto; font-size: 17px !important"> +Xem Thêm <?php echo number_format($list["es_total_result"] ,0,0,'.'); ?> Ứng Viên Liên Quan</p> </a>
                                                    </div>
                                            </div>
            ...
            $(document).ready(function() {
                ...
                $(window).scroll(function(){
                    if ($(window).scrollTop() > aboveHeight){
                        $('#resume-menu').addClass('fixed');
                        $(".fixed").css({"position": "fixed", "top": "0"});
                    } else {
                        $(".fixed").css({"position": "fixed", "top": "32px"});
                    }
                });
            });
        </script>
        <script>
            function add_vip_user() {
                swal({
                    title: 'Nâng cấp tài khoản vip',
                    text: "Hãy lựa gọi các gói tài khoản Vip của chúng tôi để xem thông tin ứng viên",
                    type: 'info',
        ...
        location.href="<?php echo home_url();?>/bang-gia/";
                }, function (dismiss) {
                    if (dismiss === 'cancel') {
                        return false;
                    }
