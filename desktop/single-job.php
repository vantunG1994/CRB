...
$td_job_expired = date('d/m/Y ', strtotime($td_job_expired));
    ...
    <div class="main-content">
            ...
            <div class="content-single" style="background: #ecf0f1;">
                <div class="container">
                    ...
                    <?php if($wpjobus_job_comm_level > 0 || strlen(trim($wpjobus_job_comm_note))>0 || $wpjobus_job_org_level > 0 || strlen(trim($wpjobus_job_org_note)) >0 || $wpjobus_job_job_rel_level > 0 || strlen(trim($wpjobus_job_job_rel_note)) >0 || !empty($wpjobus_job_skills) || strlen(trim($wpjobus_job_native_language))>0 || !empty($wpjobus_job_languages) || !empty($wpjobus_job_hobbies)) { ?>
                        ...
                        <h3 class="resume-section-title"><i class="fa fa-rocket"></i><?php _e( 'Kỹ Năng', 'themesdojo' ); ?></h3>
                            ...
                            <?php
                                                        $class_language="col-xs-6";
                                                    }
                                                else{
                                                        $class_language="none_skill";
                                                }
                            ?>
                            <div class="<?php echo $class_language;?>" style="">
                                ...
                                <?php if(strlen(trim($wpjobus_job_native_language))>0 || !empty($wpjobus_job_languages)) { ?>
                                        ...
                                        <?php
                                                                        ...
                                                                        {$languages_total++;}
                                        ?>
                                        <?php  echo $languages_total." "; _e( 'Ngôn ngữ', 'themesdojo' ); ?>
                                                                </span>
                                                            </div>
                                ...
                                ?>
                                    ...
                                    <div class="full animate"><span class="main-skills-item-title-language native-language-all"><?php echo esc_attr( $wpjobus_job_languages[$i][0] )?:"Tiếng Anh"; ?></span></div>
                    ...
                    <?php  } ?> <!-- if resume-skills -->
                        ...
                        ?>
                            ...
                            ?>
                                                        <span class="three_fourth animate" style=" margin-bottom: 0;">
