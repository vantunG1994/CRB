                    ...
                    <div class="banner-top">
                        <section id="banner-top">
							<span class="banner-hello">
								...
								<span class="job_remuneration"><b></b> 5triệu</span>
								<span class="job_remuneration_per">/ tháng</span>
							</span>
                            <h1><?php echo !empty($wpjobus_job_fullname)? $wpjobus_job_fullname :'';?></h1>
                            <h2><i class="fa fa-map-marker"></i><?php echo !empty($td_job_location)?$td_job_location:''; ?></h2>
                            <span class="cover-resume-breadcrumbs"><a rel="nofollow" href="https://mangvieclam.com/"><i class="fa fa-home"></i></a> <i class="fa fa-chevron-right"></i> <a href="https://mangvieclam.com/tuyen-dung">Tuyển dụng</a> <i class="fa fa-chevron-right"></i> <a href="https://mangvieclam.com/nganh-nghe-tuyen-dung/bao-chi-bien-tap-vien"><?php echo !empty($td_job_industry)?$td_job_industry:''; ?></a>  </span>
                        </section>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-5">
                <div class="info-details">
                    ...
                    <span class="job-info-details">
						...
						<span class="job-info-data"><?php echo !empty($td_job_location)? $td_job_location:''; ?></span>
					</span>
                    <span class="job-info-details">
                    ...
                    <span class="job-info-details">
						...
						<span class="job-info-data"><?php echo !empty($td_job_gender)? $td_job_gender :''; ?></span>
					</span>
                    ...
                    <span class="job-info-details">
						...
						<span class="job-info-data">Trung cấp</span>
					</span>
                    <span class="job-info-details">
						<span class="job-info-id"><i class="fa fa-calendar-times-o"></i>Hạn nộp hồ sơ</span>
						<span class="job-info-data"><?php echo !empty($td_job_expired)? $td_job_expired :''; ?></span>
					</span>
                </div>
            </div>
        </div>
        </div>
        <?php if($wpjobus_job_comm_level > 0 || strlen(trim($wpjobus_job_comm_note))>0 || $wpjobus_job_org_level > 0 || strlen(trim($wpjobus_job_org_note)) >0 || $wpjobus_job_job_rel_level > 0 || strlen(trim($wpjobus_job_job_rel_note)) >0 || !empty($wpjobus_job_skills) || strlen(trim($wpjobus_job_native_language))>0 || !empty($wpjobus_job_languages) || !empty($wpjobus_job_hobbies)) { ?>
            <div class="resume-skills">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <?php if($wpjobus_job_comm_level > 0 || strlen(trim($wpjobus_job_comm_note))>0 || $wpjobus_job_org_level > 0 || strlen(trim($wpjobus_job_org_note)) >0 || $wpjobus_job_job_rel_level > 0 || strlen(trim($wpjobus_job_job_rel_note)) >0 ) { ?>
                        <div class="resume-required">
                            <?php if ($wpjobus_job_comm_level > 0 ) { ?>
                                ...
                                <span class="main-skills-item-bar">
                                    <span class="main-skills-item-bar-color animate" style="width: <?php echo esc_attr( $wpjobus_job_comm_level ) ?>; background-color: rgb(46, 204, 113);"></span>
                                </span>
                            </span>
                            <?php } ?>
                            <?php if (strlen(trim($wpjobus_job_comm_note))>0) { ?>
                                <div class="full main-skills-item-note">
                                    <?php echo esc_attr( $wpjobus_job_comm_note ); ?>
                                </div>
                            <?php } ?>
                        </div>
                        <div class="resume-required">
                            <?php if ($wpjobus_job_org_level > 0 ) { ?>
                                ...
                                <span class="main-skills-item-bar">
                                    <span class="main-skills-item-bar-color animate" style="width: <?php echo esc_attr( $wpjobus_job_org_level ); ?>; background-color: rgb(231, 76, 60);"></span>
                                </span>
                            </span>
                            <?php } ?>
                            ...
                            <?php if (strlen(trim($wpjobus_job_org_note)) >0 ) { ?>
                                <div class="main-skills-item-note">
                                    <?php echo esc_attr( $wpjobus_job_org_note ); ?>
                                </div>
                            <?php  }?>
                        </div>
                        <div class="resume-required">
                            <?php if ($wpjobus_job_job_rel_level > 0 ) { ?>
                                ...
                                <span class="main-skills-item-bar">
                                    <span class="main-skills-item-bar-color animate" style="width: <?php echo esc_attr( $wpjobus_job_job_rel_level ); ?>; background-color: rgb(52, 73, 94);"></span>
                                </span>
                            </span>
                            <?php  }?>

                            <?php if (strlen(trim($wpjobus_job_job_rel_note)) >0 ) { ?>
                                <div class="main-skills-item-note">
                                    <?php echo esc_attr( $wpjobus_job_job_rel_note ); ?>
                                </div>
                            <?php } ?>
                        </div>
                    ...
                    <div class="col-xs-6">
                            ...
                            if(!empty($wpjobus_job_skills)) {
                                ...
                                <span class="main-skills-item-bar">
                                    <span class="main-skills-item-bar-color animate" style="width: <?php echo esc_attr(mt_rand(60, 100)).'%'; ?>; background-color: rgb(46, 204, 113);"></span>
                                        ...
                                        <span class="main-skills-item">
                                <span class="main-skills-item-title">
                                   <?php echo esc_attr( $wpjobus_job_skills[$i][0] ); ?>
                                </span>
                                <span class="main-skills-item-bar">
                                    <span class="main-skills-item-bar-color animate" style="width: <?php echo esc_attr( $wpjobus_job_skills[$i][1] ); ?>; background-color: rgb(46, 204, 113);"></span>
                                </span>
                            </span>
                                    <?php }}} ?>
                            <!-- <span class="main-skills-item">
                        ...
                        <?php if(strlen(trim($wpjobus_job_native_language))>0 || !empty($wpjobus_job_languages)) { ?>
                            <div class="languages">
                            ...
                            <?php if(strlen(trim($wpjobus_job_native_language))>0) { ?>
                                <div class="languages-sub">
                            <span class="main-skills-item-title-language native-language">
                                <?php echo esc_attr( $wpjobus_job_native_language ); ?>
                            </span>
                        ...
                        if(!empty($wpjobus_job_languages) ) {
                            for ($i = 0; $i < (count($wpjobus_job_languages)); $i++) {
                                ...
                                <div class="full main-skills-item-language animate">
                                    <div class="full animate"><span class="main-skills-item-title-language native-language-all"><?php echo esc_attr( $wpjobus_job_languages[$i][0] ); ?></span></div>
            ...
            <div class="full benefits-block">
				<span class="job-salary-benefits">
                    ...
                    <?php if($wpjobus_job_remuneration >0 ) {
                        ...
                        <span class="job_remuneration"><b>Thỏa thuận</span>
                        <?php
                    }
                    ?>
				</span>
                ...
                for ($i = 0; $i < (count($wpjobus_job_benefits)); $i++) {
					...
					<span class="two_third" style="margin-bottom: 0;">
						<span class="work-experience-third-block-content">
							<span class="work-experience-notes"><?php echo esc_attr($wpjobus_job_benefits[$i][1]); ?>
						</span>
					</span>
				</span>
                    <?php
