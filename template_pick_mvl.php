        ...
        <form method="post">
            <table>
                ...
                <tr>
                    ...
                    <td><input style="margin-top: 20px;" type="text" id="user_name" name="user_name"/></td>
                </tr>
                <tr>
                    <td style="position: absolute;">Gói VIP</td>
                    <?php
                    global $wpdb;
...
<!--                        <input  style="margin-top: -20px !important;" type="number" name="num_week" id="num_week_user"/>-->
                        <select name="user_vip" id="num_week_user" style="margin-top: -20px !important;width: 100% !important;height: 100% !important;">
                ...
                <tr>
                    <td><input style="margin-top: -20px;" type="submit" name="add_vip" id="submit" value="Kích hoạt"/></td>
...
if($_GET["page"]=="mvl-job")
{
    ...
    <table>
        <tr>
            <td>Nhập tên tài khoản</td>
            <td><input style="margin-top: 20px;" type="text" id="user_name_job_vip" name="user_name_job" value="<?php echo $_GET["user"] ?:"" ;?>"/></td>
            <td><input style="margin-top: 20px;" type="submit" id="load_post" name="load_post" value="Load Tin"/></td>
        ...
        if(isset($_GET['user'])) {
            ...
            <tr>
                ...
                <td>
                    <select style="height: 100%;margin-top: 20px;width: 100%" name="user_up_post" class="user_up_post">
                ...
                <td>  <select style="height: 100%;margin-top: 20px;width: 100%" name="user_vip_post" class="user_vip_post">
                ...
                <td><input style="margin-top: 20px;" type="submit" id="up_post_submit" name="up_post_submit" value="Chấp nhận"/></td>
