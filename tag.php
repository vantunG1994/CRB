        ...
        <div class="container bg-fff">
            <div class="row">
                <div class=" col-md-8 col-sm-12 col-xs-12">
                    <h1 class="content"><b><?php printf( __( '<span>%s</span>', 'themater' ), single_tag_title( '', false ) );  ?></b></h1>
                    <?php
                    $is_post_wrap = 0;
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="category-menu">
                    <ul class="menu-title">
                        <li class="title"><a style="color: white;" href="<?php echo home_url();?>/c/ket-noi-su-nghiep">Kết Nối Sự Nghiệp</a></li>
                        <?php
