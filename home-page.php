...
{
$title_mess="Gợi ý hồ sơ ứng viên.";
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-md-offset-3 ">
                    ...
                    <div class="resume-skills">
                        ...
                        <h1 class="resume-section-title"><?php _e( 'Bạn đang bế tắc?', 'themesdojo' ); ?></h1>
                        <h3 class="resume-section-subtitle"><?php _e( 'Bạn đang gặp khó khăn trong việc tìm kiếm ứng viên hay chưa tìm được việc làm phù hợp? Hãy để Mạng Việc Làm giải quyết giúp bạn.', 'themesdojo' ); ?></h3>
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="select-popup ">
                                            ...
                                            <select class="account_type_user_list select2" style="width: 100%; margin-bottom: 0;">
