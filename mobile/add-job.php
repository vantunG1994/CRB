    ...
    <form method="post">
      <div class="add-edit">
        ...
        <div class="welfare" id="result_benefit">
          ...
          <div class="job_benefits"  id="row_benefit-<?php echo $i+1; ?>">
            <?php
                  ...
                  <div class="contact-input">
                    ...
                    <span class="information-input">
                      ...
                      <span class="three_fifth">
                        ...
                        <select  vk_162b1="subscribed" vk_17ced="subscribed" class="resume_lang_speaking select2" name="wpjobus_job_languages[<?php echo $i; ?>][2]" id="wpjobus_job_languages[<?php echo $i; ?>][2]" style="width: 100%; margin-right: 10px;">
                  ...
                  <div class="contact-input">
                    <span class="information-input">
                      ...
                      <span class="three_fifth">
                        ...
                        <select   vk_162b1="subscribed" vk_17ced="subscribed" class="resume_lang_understanding select2" name="wpjobus_job_languages[<?php echo $i; ?>][1]" id="wpjobus_job_languages[<?php echo $i; ?>][1]" style="width: 100%; margin-right: 10px;">
                    ...
                    <span class="information-input">
                      ...
                      <span class="three_fifth">
                        <i class="fa fa-pencil" aria-hidden="true"></i>
                        <select  vk_162b1="subscribed" vk_17ced="subscribed" class="resume_lang_writing select2" name="wpjobus_job_languages[<?php echo $i; ?>][3]" id="wpjobus_job_languages[<?php echo $i; ?>][3]" style="width: 100%; margin-right: 10px;">
