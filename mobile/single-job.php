...
<div class="main-content">
					...
					<div class="banner-top">
                        <section id="banner-top">
                            ...
                            <?php } else{
                                ...
                                <span class="banner-hello">
                                <span class="job_work_type"><?php echo $wpjobus_job_type; ?></span>
                                <span class="job_remuneration"><?php echo "Thoả Thuận";?></span>
                                <span class="job_remuneration_per"></span>
                            </span>
                            <?php }
                            ?>
		...
		<div class="resume-skills">
            ...
            ?>
					...
					<div class="languages">
                        ...
                        ?>
						<span class="main-skills-item-title-language"><?php echo $languages_total; ?> Languages</span>
					</div>
    ...
    for ($i = 0; $i < (count($wpjobus_job_languages)); $i++) {
        ...
        <div class="full main-skills-item-language animate">
            ...
            <div class="full animate"><span class="main-skills-item-title-language native-language-all"><?php echo esc_attr($wpjobus_job_languages[$i][0]); ?></span>
            </div>
