               ...
               <span class="img-upload" >
                ...
                <span class="label-title" >
                  <h3>Địa chỉ Google Maps:</h3>
                            ...
                            <span class="three_fifth" >
                  <i class="fa fa-map-marker" aria-hidden="true"></i>
                  <input type="text" id="address" class="input-textarea ui-autocomplete-input" name="wpjobus_company_googleaddress" style="width: 100%; float: left; margin-bottom: 0;" value="<?php echo $wpjobus_company_googleaddress; ?>" placeholder="" autocomplete="off" vk_11212="subscribed">
