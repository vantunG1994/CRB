...
?>
<style>
#file_logo,#file_cover,#file_product,#file_portfolio {
border: none;
}
input#save_pending {
width: 100%;
            ...
            <div class="">
              ...
              <div class="information-input">
                ...
                infowindow.setContent('<div><strong>' + place.name + '</strong><br>' + address);
                  ...
                  <span class="three_fifth" style="margin-top: 20%" >
                    <i class="fa fa-map-marker" aria-hidden="true"></i>
                    <input type="text" id="address"  placeholder="Nhập địa chỉ Google Map"  class="input-textarea ui-autocomplete-input" name="wpjobus_company_googleaddress" style="width: 100%; float: left; margin-bottom: 0;" value="<?php echo $wpjobus_company_googleaddress; ?>" placeholder="" autocomplete="off" vk_11212="subscribed">
                  </span>
                  <div class="row">
                    <div class="col-md-6">
