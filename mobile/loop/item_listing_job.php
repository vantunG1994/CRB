...
<!--                <span class="company-name"><i class="fa fa-briefcase"></i>Công Ty TNHH Thương Mại Quốc Tế Công Nghệ</span>-->
                <div class="address"><span><i class="fa fa-map-marker" style=""></i> <?php echo $list['job_location'] ?></span></div>
                <div class="date-time"><span><i class="fa fa-calendar-o"style=""></i> <?php echo sw_human_time_diff($company_id); ?></span></div>
