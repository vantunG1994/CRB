...
$result_post = $wp2es->and_simple_search($cond_job,$order_count,$limit_count);
$td_total = $result_post["0"]["es_total_result"] ?: 0;
        ...
        <div class="row">
            <div class="col-md-8 listting">
                ...
                <div class="discription-top">
                    <h2>Tìm kiếm</h2>
                    <p>- Có <?php echo $td_total; ?> kết quả phù hợp với từ khóa <?php echo $key_search ;?></p>
