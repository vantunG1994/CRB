...
$limit_count=array('size'=>12,'page'=>1);
$result_job = $wp2es->and_simple_search($cond_job,$order_count,$limit_count);
$td_total_job = $result_job["0"]["es_total_result"];
$cond_resume=array('post_status'=>'publish','post_type'=>'resume','show_homepage'=>'yes');
$order=array('up_at'=>'desc','post_modified'=>'desc');
$limit_resume=array('size'=>12,'page'=>rand(1,100));
$result_resume = $wp2es->and_simple_search($cond_resume,$order,$limit_resume);
