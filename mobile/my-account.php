                    ...
                    <div id="menu3" class="tab-pane fade">
                        <div id="show_vip_package" class="full" style="margin-bottom: 0px; display: block;">
                            ...
                            <div class="table">
                                <div class="plan popular" id="Diamond">
                                    ...
                                    <div class="select-packge ">
                                        <select class="package_up select2">
                                            <?php
                        ...
                        <div class="col-xs-12">
                            <div class="box-company">
                                ...
                                if ($companiesNum == 0) {
                                ?>
                                <div class="add-company"><a href="<?php echo home_url(); ?>/them-ho-so-cong-ty"><i
                                class="fa fa-plus-circle"></i>Thêm hồ sơ công ty</a></div>
                                <?php
                                }
                                ?>
                                <div class="box-table">
                                    <div class="b-title text-left">Tiêu đề</div>
                                    <?php
                        ...
                        <div class="col-xs-12">
                            <div class="box-company">
                                <h1 class="text-left ac-title"><a href=""><i class="fa fa-bullhorn"></i>Tuyển dụng</a></h1>
                                <div class="add-company">
                                    ...
                                    ?>
                                    <a class="text-r" onclick="Function_user_vip()" href="#"><i
                                        class="fa fa-plus-circle"></i><?php _e('Đăng tin tuyển dụng', 'themesdojo'); ?>
                                    </a>
                                    <?php
                                    } else {
                                    ?>
                                    <a class="text-r" href="<?php $new_job = home_url('/') . "dang-tin-tuyen-dung";
                                        echo $new_job; ?>"><i
                                        class="fa fa-plus-circle"></i><?php _e('Đăng tin tuyển dụng', 'themesdojo'); ?>
                                    </a>
                                    <?php
                                    ...
                                    ?>
                                    <a class="text-r" onclick="Function_user_up_date()" href="#"><i
                                        class="fa fa-plus-circle"></i><?php _e('Đăng tin tuyển dụng', 'themesdojo'); ?>
                                    </a>
                                    <?php
                                    } else if ($count_job_monthly >= $user_monthly_max_post) {
                                    ?>
                                    <a class="text-r" onclick="Function_user_up_monthly()" href="#"><i
                                        class="fa fa-plus-circle"></i><?php _e('Đăng tin tuyển dụng', 'themesdojo'); ?>
                                    </a>
                                    <?php
                                    } else {
                                ...
                                <div class="box-table">
                                    ...
                                    <div class="list-company" id="row-<?php echo $td_result_job[$key]; ?>">
                                        ...
                                        <div style="width: 60%;" class="col-xs-6 lst-icon">
                                            ...
                                            ?>
                                            <a onclick='Function_up()' href='javascript:add_up();' data-toggle="tooltip"
                                            title="up tin ưu tiên!"><i class="fa fa-eye"></i></a>
                                            <?php
                                            } else {
                                            if ($crb_wp2es_up > 0) {
                                            ?>
                                            <a href="#" data-toggle="tooltip" title="up tin ưu tiên!">Up</i></a>
                                            <?php
                                            } else if ($count_up > 0) {
                                            ?>
                                            <a onclick='return confirm("Bạn có chắc chắn muốn up tin <?php echo $wpjobus_job_fullname ?>")'
                                                href='<?php home_url("/") ?>my-account/?up=<?php echo $postid; ?>'
                                                data-toggle="tooltip" title="up tin ưu tiên!"><i
                                            class="fa fa-eye"></i></a>
                                            <?php
                                            }
                                            }
                                            ...
                                            if ($post_vip_star != "") {
                                            ?>
                                            <a onclick='return confirm("Bạn có chắc chắn muốn cấp tin đặc biệt cho tin đăng  <?php echo $wpjobus_job_fullname ?>")'
                                                href='<?php echo home_url('/') ?>my-account?vip=<?php echo $td_result_job[$key]; ?>'
                                                data-toggle="tooltip" title="Up tin đặc biệt!"><i
                                            class="fa fa-star-o"></i></a>
                                            <?php
                                            } else {
                                            ?>
                                            <a onclick='Function_star()' href='#' data-toggle="tooltip"
                                            title="Up tin đặc biệt!"><i class="fa fa-star-o"></i></a>
                                            <?php
                                            }
                                            ?>
                                            <?php
                                            ...
                                            ?>
                                            <a href="#" data-toggle="tooltip" title="Up tin đặc biệt!">VIP</a>
                                            <?php
                                            }
                                            ?>
                                        </div>
                        ...
                        <div class="col-xs-12">
                            <div class="box-company">
                                <h1 class="text-left ac-title"><a href=""><i class="fa fa-heart"></i>Yêu thích</a></h1>
                                <div class="box-table">
                                    <div class="b-title text-left">Tiêu đề</div>
                                    <?php
                                    global $wpdb;
