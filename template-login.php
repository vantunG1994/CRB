        ...
        <div class="container content-bg">
            <div class="row">
                <div class="col-md-offset-3 col-md-6 col-xs-12">
                    ...
                    if ( $login === "failed" ) {
                        echo '<p style="color: red;"><strong>ERROR:</strong> Sai username hoặc mật khẩu.</p>';
                    } elseif ( $login === "empty" ) {
                        echo '<p style="color: red;"><strong>ERROR:</strong> Username và mật khẩu không thể bỏ trống.</p>';
                    } elseif ( $login === "false" ) {
